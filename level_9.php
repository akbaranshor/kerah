...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
	<title>Julius Caesar Level 9</title>
</head>
<body>
	<div class="container">
		...
		<div class="card">
				<div class="card-body">
					<form method="post">
						<h4 class="card-title">Teka-teki 9</h4>
						<p class="card-text">lzk{jyfwav}</p>
		...
		<?php
			if(isset($_POST['answer'])) {
				// level_5	
				// htmlentities(string)
				if ($_POST['answer'] == 'esd{crypto}') {
					header('Location: level_10.php');
				} else {
