...
<body>
	<div class="container">
		...
		<div class="card">
				...
				<div class="card-body">
					<form method="post">
						<h4 class="card-title">Teka-teki 8</h4>
						<p class="card-text">Coba ubah nilai OUTPUT menjadi tebal</p>
		...
		<?php
			if(isset($_POST['answer'])) {
				// level_5	
				// htmlentities(string)
				if($_POST['answer'] != strip_tags($_POST['answer'])) {
					    // contains HTML
					// echo "<script>alert('berhasil');</script>";
					header('Location: level_9.php');
				} else {
					echo 'OUTPUT : '.$_POST['answer'];
				}
